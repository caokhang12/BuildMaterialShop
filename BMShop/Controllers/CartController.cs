    ...
    public class CartController : Controller
    {
        ...
        public ActionResult Payment(string shipName, string moblie, string address, string email)
        {
            ...
            try
            {
                ...
                new MailHelper().SendMail(email,"Đơn hàng mới từ Cửa hàng vật liệu xây dựng", content);
                new MailHelper().SendMail(toEmail,"Đơn hàng mới từ Cửa hàng vật liệu xây dựng",content);
            } 
            catch (Exception ex)
            {
